<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('materias-primas.store') }}" x-data="materiaPrimaForm()">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="unidad_consumo" id="unidad_consumo" value="{{ old('unidad_consumo', 'unidad') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="formula_consumo" id="formula_consumo" rows="2"
                                ...
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('formula_consumo') border-red-500 @enderror">{{ old('formula_consumo') }}</textarea>
                        ...
                        <div x-show="camposInventario.length > 0" x-transition class="mb-6 border-t pt-4">
                            ...
                            <p class="text-sm text-gray-500 mb-3">Ingrese los valores para las variables definidas arriba.</p>
                        ...
                        <div class="border-t pt-4">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div class="mb-4">
                                    ...
                                    <input type="number" step="0.01" name="stock_inicial" id="stock_inicial" value="{{ old('stock_inicial', 0) }}"
    ...
    @php
        $defaultCamposInv = old('campos_inventario', []);
        $defaultCamposProd = old('campos_producto', []);
    @endphp
    <script>
        function materiaPrimaForm() {
            return {
                camposInventario: {!! json_encode($defaultCamposInv) !!},
                camposProducto: {!! json_encode($defaultCamposProd) !!},
