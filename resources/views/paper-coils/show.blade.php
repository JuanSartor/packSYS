                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 flex space-x-3">
                        ...
                        <form action="{{ route('paper-coils.destroy', $paperCoil) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700" onclick="return confirmDelete(event, '¿Está seguro de eliminar esta bobina?')">
                                Eliminar
                            </button>
                        </form>
                    </div>
