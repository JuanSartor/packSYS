                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 flex space-x-3">
                        ...
                        <form action="{{ route('clients.destroy', $client) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700" onclick="return confirm('¿Está seguro de eliminar este cliente?')">
                                Eliminar
                            </button>
                        </form>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4">
                            <p class="text-sm text-gray-600">
                                Total de ventas: <span class="font-semibold">${{ number_format($client->sales->sum('total'), 2) }}</span>
                            </p>
                        </div>
                    </div>
                </div>
