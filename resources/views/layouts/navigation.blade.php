            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->isGestor())
                        ...
                        <x-nav-link :href="route('transports.index')" :active="request()->routeIs('transports.*')">
                            Transportes
                        </x-nav-link>
                    @endif

                    @if(Auth::user()->isGestor() || Auth::user()->isVendedor())
                        <!-- Gestor and Vendedor -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->isGestor())
                ...
                <x-responsive-nav-link :href="route('transports.index')" :active="request()->routeIs('transports.*')">
                    Transportes
                </x-responsive-nav-link>
            @endif
